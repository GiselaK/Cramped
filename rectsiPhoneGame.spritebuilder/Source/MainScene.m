...
//    _begPhysicsNode= [CCPhysicsNode node];
//    _begPhysicsNode.collisionDelegate = self;
    rect=1;
    tri=1;
     _physicsNode.debugDraw= TRUE;
//    _begPhysicsNode.debugDraw = TRUE;
...
-(void) shapeSpawn{
    stopGrowth=FALSE;
    //    [self schedule:@selector(growRect) interval:0.05];
    if(!playButtonOrNah){
//        CCLOG(@"ON LINE152");
        shapeSize=0.001;
